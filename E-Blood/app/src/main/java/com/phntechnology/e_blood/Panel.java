...
SQLiteDatabase db;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.profile) {
            ...
            Intent i=new Intent(getApplicationContext(),Donate_Blood.class);
            startActivity(i);

        } else if (id == R.id.search) {
            Intent i=new Intent(getApplicationContext(),Search_Donor.class);
            startActivity(i);
            ...
            Intent i=new Intent(getApplicationContext(),Remove_Donor.class);
            startActivity(i);
        }
